...
function HowItWorks(props) {
  ...
  return (
    <div className="fixed overflow-y-auto z-10 top-0 right-0 left-0 w-full h-full bg-opacity-30 backdrop-blur-sm">
            ...
            <Dropdown
              ...
              description={
                <div>
                  ...
                  process tiring and time-consuming. To make it simpler, I
                  devised a way to track{" "}
                  <strong>how much I spend per week</strong> by recording my
                  account balance at the beginning and end of the week. By
                  calculating the difference, I can easily see my weekly
                  spending. If the amount is alarming, I know I need to adjust
                  my buying habits.
                </div>
              }
            />
